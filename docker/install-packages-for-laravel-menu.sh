...
function menu() {
    ...
    do
        ...
        echo "5. 安裝 barryvdh/laravel-cors"
        echo ""
        echo "Debug tool:"
        echo "6. 安裝 laravel telescope"
        echo "7. 安裝 recca0120/laravel-tracy"
        echo "8. 安裝 barryvdh/laravel-debugbar"
        echo ""
        echo "----------"
        echo ""
        echo "q. 離開"
        ...
        case $opt in
            ...
            4) echo "************ 安裝 recca0120/upload *************";
                ...
                echo "按下 [enter] 鍵繼續. . .";
                read enterKey;;
            5) echo "************ 安裝 barryvdh/laravel-cors *************";
                ./install-barryvdh_laravel-cors.sh
                echo "按下 [enter] 鍵繼續. . .";
                read enterKey;;
            6) echo "************ 安裝 laravel telescope *************";
                ./install-laravel-telescope.sh
                echo "按下 [enter] 鍵繼續. . .";
                read enterKey;;
            7) echo "************ 安裝 recca0120/laravel-tracy *************";
                ./install-recca0120_laravel-tracy.sh
                echo "按下 [enter] 鍵繼續. . .";
                read enterKey;;
            8) echo "************ 安裝 barryvdh/laravel-debugbar *************";
